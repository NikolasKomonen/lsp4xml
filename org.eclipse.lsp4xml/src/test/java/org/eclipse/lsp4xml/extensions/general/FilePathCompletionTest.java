 ...
 * 
 * The working directory for the following tests is:
...
public class FilePathCompletionTest {
	...
	@Test
	public void testFilePathCompletionWithWiderReplaceRange() throws BadLocationException {
		String xml = "<a path=\"./fo|lderA\">";
		CompletionItem[] items = getCompletionItemList("/", 0, 10, 18, "folderA");
		testCompletionFor(xml, 4, items);
	}
	
	@Test
	public void testFilePathCompletionWithWiderReplaceRangeBackSlash() throws BadLocationException {
		String xml = "<a path=\".\\fo|lderA\">";
		CompletionItem[] items = getCompletionItemList("\\", 0, 10, 18, "folderA");
		testCompletionFor(xml, 4, items);
	}
	...
	@Test
	public void testFilePathCompletionWithWiderReplaceRangeMidPath() throws BadLocationException {
		String xml = "<a path=\"./fo|lderA/xsdA1.xsd\">";
		CompletionItem[] items = getCompletionItemList("/", 0, 10, 28, "folderA");
		testCompletionFor(xml, 4, items);
	}

	@Test
	public void testFilePathCompletionWithWiderReplaceRangeMidPathBackSlash() throws BadLocationException {
		String xml = "<a path=\".\\fo|lderA\\xsdA1.xsd\">";
		CompletionItem[] items = getCompletionItemList("\\", 0, 10, 28, "folderA");
		testCompletionFor(xml, 4, items);
	}
